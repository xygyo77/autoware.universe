...
class TTCVisualizer(Node):
    def __init__(self, args):
        ...
        self.ttc_dist_pub = self.create_subscription(
            ...
            "/planning/scenario_planning/lane_driving/behavior_planning/behavior_velocity_planner/debug/roundabout/ego_ttc",
            self.on_ego_ttc,
            1,
        )
        self.ttc_time_pub = self.create_subscription(
            Float64MultiArrayStamped,
            "/planning/scenario_planning/lane_driving/behavior_planning/behavior_velocity_planner/debug/roundabout/object_ttc",
            self.on_object_ttc,
            1,
        )
        self.args = args
