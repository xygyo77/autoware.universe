...
private:
  ...
  private:
    ...
    tilde::tildePublisher<PointCloud2>::SharedPtr outlier_pointcloud_pub_;
    tilde::tildePublisher<PointCloud2>::SharedPtr low_confidence_pointcloud_pub_;
    tilde::tildePublisher<PointCloud2>::SharedPtr high_confidence_pointcloud_pub_;
    const OccupancyGridMapOutlierFilterComponent & node_;
  };

private:
  // publishers and subscribers
  tilde::tildePublisher<PointCloud2>::SharedPtr pointcloud_pub_;
